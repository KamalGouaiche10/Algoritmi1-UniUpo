...
int main()
{
    ...
    for (i = 1; i <= n; ++i)
    {
        ...
        printf("Test Bidirectional Selection Sort: case #%lu => %s\n", i, (ret == TEST_OK) ? "[OK]" : "[FAIL]");
    }
...
int test_sort1()
{
    ...
    /* Applies the bidirectional selection sort algorithm and checks that it works */

    upo_bidi_selection_sort(a, n, sizeof a[0], int_comparator);
...
int test_sort4()
{
    ...
    upo_bidi_selection_sort(a, n, sizeof a[0], double_comparator);
    for (i = 0; i < n && ret == TEST_OK; ++i)
    {
...
int test_sort5()
{
    ...
    upo_bidi_selection_sort(a, n, sizeof a[0], string_comparator);
    for (i = 0; i < n && ret == TEST_OK; ++i)
    {
...
int test_sort6()
{
    ...
    upo_bidi_selection_sort(a, n, sizeof a[0], item_comparator);
    for (i = 0; i < n && ret == TEST_OK; ++i)
    {
